 ...
 * 重新导入品牌营销区域数据。
 */
export const brandMarketingRefreshRegionalData = <ThrowOnError extends boolean = false>(options?: Options<BrandMarketingRefreshRegionalDataData, ThrowOnError>): RequestResult<BrandMarketingRefreshRegionalDataResponses, unknown, ThrowOnError> => (options?.client ?? client).post<BrandMarketingRefreshRegionalDataResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
