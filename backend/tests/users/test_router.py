...
def test_create_user_new_username(
    ...
    created_user = r.json()
    user = users_service.get_user_by_username(session=db, username=username)
    assert user
...
def test_get_existing_user_as_superuser(
    ...
    assert 200 <= r.status_code < 300
    api_user = r.json()
    existing_user = users_service.get_user_by_username(session=db, username=username)
...
def test_delete_user_current_super_user_error(
    ...
    super_user = users_service.get_user_by_username(
